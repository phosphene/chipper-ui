...
const DEMO_RESULT = {
  ...
  dimensionScores: [
    { dimension: 'N' as Dimension,  rawScore: 4.0, weight: 1.0, weightedScore: 4.0,   justification: 'Structurally expected for a null result. The contribution is methodological rather than conceptual.', keyPassage: null },
    { dimension: 'E' as Dimension,  rawScore: 8.0, weight: 1.5, weightedScore: 12.0,  justification: 'Three independent community studies with controlled comparisons. The methodology section is the paper\'s strongest contribution.', keyPassage: 'Across all three sites, feedback loop indicators showed no statistically significant deviation from baseline ecological variation (p > 0.3 in all comparisons).' },
    { dimension: 'P' as Dimension,  rawScore: 5.0, weight: 1.2, weightedScore: 6.0,   justification: 'General prior applies; no domain variant available for this field yet.', keyPassage: null },
    { dimension: 'C' as Dimension,  rawScore: 7.0, weight: 1.0, weightedScore: 7.0,   justification: 'Framework holds throughout. No internal contradictions.', keyPassage: null },
    { dimension: 'S' as Dimension,  rawScore: 7.0, weight: 1.0, weightedScore: 7.0,   justification: 'Economical apparatus. Only the complexity the problem requires.', keyPassage: null },
    { dimension: 'Sc' as Dimension, rawScore: 5.0, weight: 0.8, weightedScore: 4.0,   justification: 'Limited to three study sites. Scope honestly stated.', keyPassage: null },
    { dimension: 'L' as Dimension,  rawScore: 7.0, weight: 1.0, weightedScore: 7.0,   justification: 'Well-situated in prior work. Engages with critics.', keyPassage: null },
    { dimension: 'M' as Dimension,  rawScore: 8.5, weight: 1.5, weightedScore: 12.75, justification: 'Excellent calibration. The null finding is stated as a null finding, not as proof of absence.', keyPassage: 'We do not conclude that niche construction feedback loops are absent — only that they are not detectable at the temporal resolution our methodology affords.' },
    { dimension: 'D' as Dimension,  rawScore: 6.0, weight: 0.8, weightedScore: 4.8,   justification: 'Some boundary conditions stated. Could be more explicit about when the framework does not apply.', keyPassage: null },
  ],
